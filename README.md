...
![YouEDA search, output directory, and generation log](youeda-search-and-batch.png)

*Part search and output workflow.*

![Generated Altium footprint on Top Overlay](altium-top-overlay.png)

## Complete source tree

Download [YouEDA-source.zip](YouEDA-source.zip) for the complete source tree, including the `src/`, `docs/`, and screenshot folders. The source archive contains the same local Git commit prepared for this repository.
